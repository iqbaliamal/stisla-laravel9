              ...
              <div class="card-body">
                ...
                <form method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control pwstrength" id="password" name="password" data-indicator="pwindicator"
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="password-confirm" name="confirm-password" type="password"
                      tabindex="2" required>
                  </div>
